 ...
 ******************************************************************************
  ...
  1.��    ��  :
  2.��    ��  :
    �޸�����   :20221210 ������CANFD�ڵ��ʼ���ĺ�����CANFD�����жϵĺ�����CANFD���ݷ��ͳ�ʼ
    ����������ģ���ʼ��������������CAN��CANFD��ѡ���������CANFD���ͺͽ��յ�ID���塣����
  20221212���Ҫ��CANFD��ֻ����8���ֽڵ����ݣ���ô����Ҫ��CANFD��ʼ������void
  CAN_TLE9252_config_node0_CANFD(void)�У��ѷ����ֽڳ���canMsgObjConfig.control.messageLen
  = IfxMultican_DataLengthCode_32;��ΪIfxMultican_DataLengthCode_8;Ȼ���ٸ������ġ�
******************************************************************************/
...
/******************************************************************************/
/*
// ���ڵ�ַ���䣬��Ӧ��û�����ϣ��ο�20221121�Թ�����CANFD��������
#pragma align 32
...
// �շ�������
DataQueue gl_rxDataQueue;// ���ջ�����
DataQueue gl_txDataQueue;// ���ͻ�����
...
void DrvCanRxTxModeSet(uint8 mode)
{
	...
	for(int j = 0; j < CanTxFrm9252Num; j++)
	{
		...
		else if(mode == UDS_CC_MODE_RX_TX)	// ʹ�ܽ���
		{

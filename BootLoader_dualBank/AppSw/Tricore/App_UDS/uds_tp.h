...
/* Define FIFO length */
#define TX_TP_QUEUE_LEN (256u)  /* UDS send message to TP max length */
#define RX_TP_QUEUE_LEN (256u)  /* UDS read message from TP max length */

#define RX_BUS_FIFO_LEN     (256u)      /* RX BUS FIFO length */
#define RX_BUS_FIFO         ('r')       /* RX bus FIFO ASCII????114*/
#define TX_BUS_FIFO         ('t')       /* RX bus FIFO ASCII????116*/
#define TX_BUS_FIFO_LEN     (256u)      /* RX BUS FIFO length */
...
#define MAX_CF_DATA_LEN         (256u)  /* Max Consecutive Frame data len */

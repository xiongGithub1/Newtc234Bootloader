...
#define ISR_PRIORITY_GPT12_T2   	26 /**< \brief Define the Incremental encoder zero interrupt priority.  */

#define ISR_PRIORITY_GPT12_T6   	27
...
#define ISR_PRIORITY_STM_INT0		100
